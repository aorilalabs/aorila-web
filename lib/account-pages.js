...
const FOOTER =
  '<footer class="site-footer"><div class="wrap"><nav class="footer-links" aria-label="Legal"><a href="/tp">T & P</a><a href="/support">Support</a><a href="/partner">Partners</a><a href="/contact">Contact</a><a href="https://api.aorila.com">Developer</a></nav><div class="footer-meta"><span>Aorila — to help people.</span></div></div></footer>';
...
function consolePage({ user, balanceCents, machines, bookings, endpoints, volumes, credits, error, notice, section }) {
  ...
  const actions = `<div class="console-actions"><a class="cta ghost" href="/console">Customize</a><a class="cta primary" href="/console/new">+ New</a></div>`;
  const eps = endpoints || [];
  const vols = volumes || [];
  ...
  if (sec === 'billing') {
    ...
    main = `${flash}<h1>${sec === 'clusters' ? 'Clusters' : 'Deployments'}</h1>${actions}<div class="console-card"><p class="console-note">Multi-node and reserved layouts go through Commercial.</p><a class="cta ghost" href="/commercial/console">Open commercial</a></div>`;
  } else if (sec === 'pods') {
  ...
  return wrap({
    ...
    body: `<main>
      <section class="hero compact"><div class="wrap">
        <span class="hero-badge">Commercial</span>
      ...
      <section class="section"><div class="wrap">
        <nav class="chips" aria-label="Commercial" style="margin-bottom:26px">
