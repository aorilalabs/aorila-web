  ...
  <div class="console-app">
    ...
    <div class="console-frame">
      <nav class="console-nav" id="console-nav" aria-label="Console">
        ...
        <a href="https://dashboard.aorilalabs.com/">Aorila Labs dashboard</a>
...
// Parent-company console (Aorila): account, billing, updates. Compute lives on
// the Aorila Labs dashboard — never here.
function consolePage({ user, balanceCents, bookings, credits, error, notice, section }) {
  ...
  if (sec === 'billing') {
    ...
    main = `${flash}<h1>Welcome back, ${esc(first)}.</h1>${tabs}${bookings && bookings.length ? `<div class="console-card"><h2>Capacity</h2>${bookingRows(bookings)}</div>` : ''}<div class="console-card"><p class="console-note">Compute moved to the Aorila Labs dashboard: <a href="https://dashboard.aorilalabs.com/">dashboard.aorilalabs.com</a></p></div>`;
  }
