...
const PAGES = {
  ...
  pods: { title: 'Pods', badge: 'Product', heading: 'On-demand GPUs from live pools.', lede: 'Single-GPU machines from verified partners — RunPod, Vast.ai, TensorDock, and Voltage Park. Per-minute billing, one Aorila bill — workloads stop at $0.' },
  ...
  pricing: { title: 'Pricing', badge: 'Pricing', heading: 'Live Aorila price.', lede: 'One $/hour number per GPU, pulled from live partner pools. 1 credit = $1.' },
...
function renderMarketingPage(slug, { query, user } = {}) {
  ...
  if (slug === 'contact') {
    extra = `<div class="btn-row"><a class="btn acid" href="/commercial">Enterprise</a><a class="btn ink" href="mailto:api@aorila.com">api@aorila.com</a></div>`;
  ...
  if (slug === 'articles') {
    below = `<section class="section"><div class="wrap"><div class="section-head"><span class="snum">GUIDES</span><div><h2>How Aorila works</h2></div></div><div class="cards">
      ...
      <div class="card"><span class="tag">PRICING</span><h3>One bill for many pools</h3><p>Our GPUs come from verified partners — RunPod, Vast.ai, TensorDock, and Voltage Park. We publish one live $/hour price per GPU in the catalog on this site — the same number you're billed. One Aorila bill, no provider invoices.</p></div>
    </div></div></section>`;
  }
  ...
  if (slug === 'about') {
    below = `<section class="section"><div class="wrap"><div class="section-head"><span class="snum">WHAT WE DO</span><div><h2>Plainly</h2></div></div><div class="cards">
      <div class="card"><span class="tag">WE DO</span><h3>Run AI infrastructure</h3><p>On-demand GPUs — pods, serverless, clusters — from verified partners (RunPod, Vast.ai, TensorDock, Voltage Park), plus AI models on atraly.com. Per-minute billing, one bill.</p></div>
