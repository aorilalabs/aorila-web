...
function renderMarketingPage(slug, { query, user } = {}) {
  ...
  if (slug === 'contact') {
    extra = `<div class="btn-row"><a class="btn acid" href="/commercial">Enterprise</a><a class="btn ink" href="mailto:api@aorila.com">api@aorila.com</a><a class="btn" href="mailto:info@aorila.com">info@aorila.com</a></div>`;
  ...
  if (slug === 'about') {
    ...
    <section class="section" style="padding-top:0"><div class="wrap"><div class="section-head"><span class="snum">THE COMPANY</span><div><h2>One company, three divisions</h2><p class="lede">Our goal: to help people — building toward advanced robotics for everyday life.</p></div></div><div class="cards">
