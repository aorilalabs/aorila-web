...
const PAGES = {
  ...
  pods: { title: 'Pods', badge: 'Product', heading: 'On-demand GPUs from live pools.', lede: 'Single-GPU machines from verified provider pools. Per-minute billing, one Aorila bill.' },
  serverless: { title: 'Serverless', badge: 'Product', heading: 'Serverless GPU endpoints.', lede: 'Scale to zero. Pay only for the time your code runs.' },
  clusters: { title: 'Clusters', badge: 'Product', heading: 'Multi-node GPU clusters.', lede: 'Distributed training and inference across many nodes.' },
  hub: { title: 'Hub', badge: 'Product', heading: 'Models and templates.', lede: 'One-click templates for open-source models.' },
  deployments: { title: 'Deployments', badge: 'Product', heading: 'One control plane.', lede: 'Every workload, managed from a single dashboard.' },
