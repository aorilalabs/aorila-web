...
/**
 * aorila-web authenticates against the shared Supabase project: one login
 * works on aorila.com, atraly.com, and the Aorila Labs dashboard.
 * Server-side only:
...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://lbdmaxagsxztihaaecec.supabase.co';
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || 'sb_publishable_4IM5RvuX21oz4i1FJ8gg7g_0JjaaCP3';
