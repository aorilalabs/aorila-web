...
/**
 * aorila-web authenticates against the shared Atraly Supabase project, so one
 * login works on atraly.com and aorila.com. Server-side only: we call the
 * Supabase Auth API with the public anon key (the same key atraly.com serves
 * to every browser), then keep our own HMAC session cookie for the console.
 *
