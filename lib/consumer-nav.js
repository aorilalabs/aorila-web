...
function consumerNav(opts = {}) {
  ...
  const product = dropdown('Product', [
    { href: '/models', title: 'AI Models', desc: 'Atraly and Aorila models on atraly.com' },
    { href: '/console/pods', title: 'Pods', desc: 'On-demand GPUs, deployed across 31 global regions' },
    { href: '/console/serverless', title: 'Serverless', desc: 'Run API-based AI workloads with serverless GPU endpoints' },
    { href: '/console/clusters', title: 'Clusters', desc: 'Run multi-node GPU clusters for distributed AI workloads' },
    { href: '/console/hub', title: 'Hub', desc: 'Deploy open-source AI models and templates on Aorila' },
    {
