...
function mark(href, attrs) {
  return `<a class="wordmark" href="${esc(href)}"${attrs || ''} aria-label="Aorila">
      <svg class="wordmark-svg" viewBox="0 0 220 64" aria-hidden="true">
        <text x="110" y="42" text-anchor="middle">Aorila</text>
        <rect x="94" y="52" width="32" height="1.5" />
      </svg>
    </a>`;
}
