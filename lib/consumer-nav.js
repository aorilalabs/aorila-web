...
function consumerNav(opts = {}) {
  ...
  const brand = onCommercial
    ? `<a class="wordmark" href="/commercial">Commercial</a>
    <a class="nav-commercial" href="/">Aorila</a>`
    : `<a class="wordmark" href="${esc(wordmarkHref)}"${wordmarkHref === 'https://aorila.com' ? ' data-local-site="consumer"' : ''}>Aorila</a>
    <a class="nav-commercial" href="/commercial">Commercial</a>`;
