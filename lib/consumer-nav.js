/** Shared consumer header: marketing menu in right sidebar. */
...
function consumerNav(opts = {}) {
  ...
  const product = dropdown('Product', [
    { href: '/ai-api', title: 'AI API', desc: 'Atraly and Aorila models on atraly.com' },
    { href: '/pods', title: 'Pods', desc: 'On-demand GPUs from live provider pools' },
    { href: '/serverless', title: 'Serverless', desc: 'Scale-to-zero GPU endpoints' },
    { href: '/clusters', title: 'Clusters', desc: 'Multi-node GPU clusters for distributed workloads' },
    { href: '/hub', title: 'Hub', desc: 'One-click models and templates' },
    { href: '/deployments', title: 'Deployments', desc: 'Every workload from one control plane' },
  ]);
  ...
  const company = dropdown('Company', [
    ...
    { href: '/providers', title: 'Become a provider', desc: 'List your GPUs on the Aorila network' },
  ...
  return `<header class="nav">
    ...
    ${chip('/commercial', 'Enterprise', !onCommercial)}
  ...
  <aside class="nav-sidebar" id="site-nav" hidden aria-label="Site menu">
    ...
    <nav class="nav-primary" aria-label="Primary">
      ...
      <a class="nav-link" href="/commercial">Enterprise</a>
    </nav>
